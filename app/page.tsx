      ...
      <section className="max-w-7xl mx-auto px-6 pt-20 pb-16 md:pt-32 md:pb-24">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-zinc-600 dark:text-zinc-400 mb-10 max-w-2xl mx-auto leading-relaxed">
            A clean, focused platform for home cooks and food lovers to
            organize, share, and discover recipes without the noise.
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 md:gap-12">
          ...
          <div className="bg-white dark:bg-zinc-900 p-8 rounded-2xl shadow-sm border border-zinc-100 dark:border-zinc-800 hover:shadow-md transition-shadow">
            ...
            <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
              Create, edit, and organize your recipes with a clean, intuitive
              interface. Save as drafts or publish when ready.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-zinc-900 p-8 rounded-2xl shadow-sm border border-zinc-100 dark:border-zinc-800 hover:shadow-md transition-shadow">
            ...
            <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
              Share publicly, with followers only, or select specific people.
              You decide who sees your culinary creations.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-zinc-900 p-8 rounded-2xl shadow-sm border border-zinc-100 dark:border-zinc-800 hover:shadow-md transition-shadow">
            ...
            <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
              Discover recipes from home cooks, chefs, and food bloggers you
              trust. No ads, no clutter, just great food.
            </p>
          </div>
        </div>
      </section>
