...
export function LandingPage() {
  ...
  return (
    <>
        ...
        <section className="max-w-7xl mx-auto px-6 pt-20 pb-16 md:pt-32 md:pb-24">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <a
                href="/feed"
                className="border-2 border-zinc-200 dark:border-zinc-700 hover:border-orange-500 dark:hover:border-orange-500 text-zinc-900 dark:text-white px-8 py-4 rounded-full font-semibold text-lg transition-all w-full sm:w-auto text-center"
              >
                Explore Recipes
              </a>
            </div>
      ...
      {/* Auth Modals */}
      <AuthModal isOpen={authMode === 'login'} onClose={closeAuth}>
        <LoginForm onSwitchToSignup={openSignup} />
      </AuthModal>

      <AuthModal isOpen={authMode === 'signup'} onClose={closeAuth}>
